...
export const expertiseDetails = [
    ...
    },
    {
      ...
      title: "Node.js",
      descriptions: [
        "Node.js deals with API or real-time web programming, allowing the creation of sophisticated web applications.",
        "Node.js apps can handle a significant amount of traffic and are highly scalable.",
        "Our team of skilled designers provides creative and visually appealing web and mobile app UI/UX development services following the latest design trends.",
        "ResourceOne offers high-performing and scalable enterprise-oriented API development services tailored to your business needs.",
        "We assist with migrating your website to Node.js or updating its current version.",
        "ResourceOne provides round-the-clock Node.js support and maintenance services for our valued customers."
      ]
    ...
    },
    {
      ...
      title: "React Native",
      descriptions: [
        "If you want to migrate your app to the React Native platform or update its current version, we are always ready to assist you.",
        "We provide high-performing and accessible enterprise-oriented React Native app solutions tailored to your specific business needs.",
        "Our expertise extends to offering round-the-clock React Native app development support and maintenance services.",
        "From the initial stages, our quality analysts ensure your app runs seamlessly across all browsers and screens.",
        "ResourceOne delivers end-to-end React Native solutions, including prototyping, UI/UX design, development, and deployment."
      ]
    },
    {
      id: 3,
      title: "Angular.JS",
      descriptions: [
        "Choose Angular.JS development services from ResourceOne to build reliable, scalable, and dynamic applications.",
        "We offer high-performing and scalable enterprise-oriented API development services tailored to your business needs.",
        "Our AngularJS developers provide round-the-clock support and maintenance services for our esteemed clients.",
        "Angular.JS development services are cost-effective, minimize development time, and offer mobile-friendly solutions.",
        "Our result-driven software development services help increase ROI and efficiently manage daily workflows."
      ]
    },
    {
      id: 4,
      title: "React.JS",
      descriptions: [
        "ResourceOne is trusted for React.JS development expertise, offering web app solutions tailored to your business needs.",
        "We provide responsive web applications with tailored themes, feature-rich plugins, and mobile-friendly interfaces.",
        "Our team ensures perfect code quality, responsive and user-friendly design, and an upgraded navigation system.",
        "We prioritize scalability and security with advanced measures like high-security plugins, data encryption, and secure admin dashboards.",
        "With years of experience, ResourceOne has satisfied numerous clients by understanding React.JS intricacies and fulfilling client needs with excellence."
      ]
    },
    {
      id: 5,
      title: "Vue.JS",
      descriptions: [
        "Vue.JS is our preferred development framework, ensuring fast response times and improved performance.",
        "Our experienced developers are proficient in third-party integrations using Vue.JS.",
        "ResourceOne offers comprehensive Vue.JS services, including consultation, planning, and final web app development.",
        "We provide full support and maintenance for Vue.JS web applications to ensure ongoing customer satisfaction.",
        "We guarantee timely delivery of results, meeting or exceeding expectations.",
        "Each project is overseen by a technical lead, ensuring the team’s expertise aligns with project requirements."
      ]
    },
    {
      id: 6,
      title: "Android",
      descriptions:  [
        "ResourceOne excels in providing secure, accessible, and high-performing Android applications.",
        "We design enterprise-oriented Android app solutions tailored to meet specific business needs.",
        "Our apps ensure maximum scalability and security using advanced encryption and secure admin dashboards.",
        "ResourceOne delivers end-to-end Android app development, from UI/UX design to deployment in app stores.",
        "We offer flexible engagement models to address varied business requirements within specified timelines."
      ]
    ...
    },
    {
      ...
      title: "iOS",
      descriptions: [
        "ResourceOne offers a wide range of iOS application development services, including full-stack development, migration, and business-oriented solutions.",
        "Our expertise ensures the delivery of top-notch iOS app development tailored to meet client needs.",
